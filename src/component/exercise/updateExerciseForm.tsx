...
const ExerciseDetailsForm: React.FC = () => {
    const { id } = useParams();
    ...
    const actionButtonAction: Function = (sportId: number, videoUrl: string, sportsmanId: number): void => {
        if (!exercise) {
            return;
        }
    ...
    return <ExerciseForm title="Exercise Details" actionButtonText="Save"
